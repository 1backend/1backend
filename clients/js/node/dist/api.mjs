...
class ImageSvcApi {
     ...
     */
    serveDownloadedImage(url_1, width_1, height_1, quality_1, format_1) {
        return __awaiter(this, arguments, void 0, function* (url, width, height, quality, format, options = { headers: {} }) {
