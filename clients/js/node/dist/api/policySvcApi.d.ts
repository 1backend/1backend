...
export declare class PolicySvcApi {
     ...
     */
    check(policySvcCheckRequest: PolicySvcCheckRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    upsertInstance(instanceId: string, policySvcUpsertInstanceRequest: PolicySvcUpsertInstanceRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
