...
export declare class PromptSvcApi {
     ...
     */
    listPrompts(promptSvcListPromptsRequest?: PromptSvcListPromptsRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    prompt(promptSvcPromptRequest: PromptSvcPromptRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    removePrompt(promptSvcRemovePromptRequest: PromptSvcRemovePromptRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
