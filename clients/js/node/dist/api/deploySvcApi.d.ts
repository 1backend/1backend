...
export declare class DeploySvcApi {
     ...
     */
    deleteDeployment(deploySvcDeleteDeploymentRequest?: DeploySvcDeleteDeploymentRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    saveDeployment(deploySvcSaveDeploymentRequest?: DeploySvcSaveDeploymentRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
