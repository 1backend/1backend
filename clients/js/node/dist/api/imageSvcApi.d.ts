...
export declare class ImageSvcApi {
     ...
     */
    serveDownloadedImage(url: string, width?: number, height?: number, quality?: number, format?: string, fit?: string, position?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param position Crop anchor when fit&#x3D;cover: center|top|bottom|left|right|top-left|top-right|bottom-left|bottom-right
     */
    serveUploadedImage(fileId: string, width?: number, height?: number, fit?: string, position?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
