...
export declare class DataSvcApi {
     ...
     */
    createObject(dataSvcCreateObjectRequest: DataSvcCreateObjectRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    deleteObjects(dataSvcDeleteObjectRequest: DataSvcDeleteObjectRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    queryObjects(dataSvcQueryRequest?: DataSvcQueryRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    updateObjects(dataSvcUpdateObjectsRequest: DataSvcUpdateObjectsRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    upsertObject(objectId: string, dataSvcUpsertObjectRequest: DataSvcUpsertObjectRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param dataSvcUpsertObjectRequest Upsert request payload
     */
    upsertObjects(dataSvcUpsertObjectRequest: DataSvcUpsertObjectRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
