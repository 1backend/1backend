...
export declare class ProxySvcApi {
     ...
     */
    listCerts(proxySvcListCertsRequest?: ProxySvcListCertsRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    listRoutes(proxySvcListRoutesRequest?: ProxySvcListRoutesRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    saveCerts(proxySvcSaveCertsRequest: ProxySvcSaveCertsRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    saveRoutes(proxySvcSaveRoutesRequest: ProxySvcSaveRoutesRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
