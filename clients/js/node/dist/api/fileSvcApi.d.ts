...
export declare class FileSvcApi {
     ...
     */
    downloadFile(fileSvcDownloadFileRequest: FileSvcDownloadFileRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param body
     */
    getDownload(url: string, body?: object, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param body
     */
    listDownloads(body?: object, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    listUploads(fileSvcListUploadsRequest?: FileSvcListUploadsRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param body
     */
    pauseDownload(url: string, body?: object, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param body
     */
    serveUpload(fileId: string, body?: object, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
