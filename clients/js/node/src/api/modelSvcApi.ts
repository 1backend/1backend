...
export class ModelSvcApi {
     ...
     * @summary List Models
     */
    public async listModels (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ModelSvcListModelsResponse;  }> {
     ...
     */
    public async listPlatforms (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ModelSvcListPlatformsResponse;  }> {
