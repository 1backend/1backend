...
export class EmailSvcApi {
     ...
     */
    public async sendEmail (emailSvcSendEmailRequest: EmailSvcSendEmailRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: EmailSvcSendEmailResponse;  }> {
