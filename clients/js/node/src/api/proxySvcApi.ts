...
export class ProxySvcApi {
     ...
     */
    public async listCerts (proxySvcListCertsRequest?: ProxySvcListCertsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ProxySvcListCertsResponse;  }> {
     ...
     */
    public async listRoutes (proxySvcListRoutesRequest?: ProxySvcListRoutesRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ProxySvcListRoutesResponse;  }> {
     ...
     */
    public async saveCerts (proxySvcSaveCertsRequest: ProxySvcSaveCertsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: object;  }> {
        const localVarPath = this.basePath + '/proxy-svc/certs';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
     ...
     */
    public async saveRoutes (proxySvcSaveRoutesRequest: ProxySvcSaveRoutesRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ProxySvcSaveRoutesResponse;  }> {
        const localVarPath = this.basePath + '/proxy-svc/routes';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
