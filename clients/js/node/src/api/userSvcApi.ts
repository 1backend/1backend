...
export class UserSvcApi {
     ...
     */
    public async beginTOTPSetup (body?: object, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UserSvcBeginTOTPSetupResponse;  }> {
