...
export class UserSvcApi {
     ...
     */
    public async isAuthorized (permission: string, body?: UserSvcIsAuthorizedRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UserSvcIsAuthorizedResponse;  }> {
        const localVarPath = this.basePath + '/user-svc/permission/{permission}/is-authorized'
        ...
        if (permission === null || permission === undefined) {
            throw new Error('Required parameter permission was null or undefined when calling isAuthorized.');
        }
