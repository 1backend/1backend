...
export class DeploySvcApi {
     ...
     */
    public async deleteDeployment (deploySvcDeleteDeploymentRequest?: DeploySvcDeleteDeploymentRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: object;  }> {
     ...
     */
    public async saveDeployment (deploySvcSaveDeploymentRequest?: DeploySvcSaveDeploymentRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: object;  }> {
        const localVarPath = this.basePath + '/deploy-svc/deployment';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
