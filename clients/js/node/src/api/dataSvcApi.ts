...
export class DataSvcApi {
     ...
     */
    public async createObject (dataSvcCreateObjectRequest: DataSvcCreateObjectRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DataSvcCreateObjectResponse;  }> {
     ...
     */
    public async deleteObjects (dataSvcDeleteObjectRequest: DataSvcDeleteObjectRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: object;  }> {
     ...
     */
    public async queryObjects (dataSvcQueryRequest?: DataSvcQueryRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DataSvcQueryResponse;  }> {
     ...
     */
    public async updateObjects (dataSvcUpdateObjectsRequest: DataSvcUpdateObjectsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: object;  }> {
     ...
     */
    public async upsertObject (objectId: string, dataSvcUpsertObjectRequest: DataSvcUpsertObjectRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DataSvcUpsertObjectResponse;  }> {
     ...
     * @param dataSvcUpsertObjectRequest Upsert request payload
     */
    public async upsertObjects (dataSvcUpsertObjectRequest: DataSvcUpsertObjectRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DataSvcUpsertObjectResponse;  }> {
