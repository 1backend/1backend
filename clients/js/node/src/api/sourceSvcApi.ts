...
export enum SourceSvcApiApiKeys {
    BearerAuth,
}

export class SourceSvcApi {
    ...
    public setApiKey(key: SourceSvcApiApiKeys, value: string) {
        (this.authentications as any)[SourceSvcApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async checkoutRepo (body: SourceSvcCheckoutRepoRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SourceSvcCheckoutRepoResponse;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: SourceSvcCheckoutRepoResponse;  }>((resolve, reject) => {
