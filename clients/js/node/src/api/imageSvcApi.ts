...
export class ImageSvcApi {
     ...
     */
    public async serveDownloadedImage (url: string, width?: number, height?: number, quality?: number, format?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Buffer;  }> {
     ...
     * @param height Optional height to resize the image to
     */
    public async serveUploadedImage (fileId: string, width?: number, height?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Buffer;  }> {
