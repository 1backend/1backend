...
export class FirehoseSvcApi {
     ...
     */
    public async publishEvent (firehoseSvcEventPublishRequest: FirehoseSvcEventPublishRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
     ...
     * @param body 
     */
    public async subscribeToEvents (body?: object, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
