...
export class SecretSvcApi {
     ...
     */
    public async decryptValue (secretSvcDecryptValueRequest: SecretSvcDecryptValueRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SecretSvcDecryptValueResponse;  }> {
     ...
     */
    public async encryptValue (secretSvcEncryptValueRequest: SecretSvcEncryptValueRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SecretSvcEncryptValueResponse;  }> {
     ...
     * @param body 
     */
    public async isSecure (body?: object, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SecretSvcIsSecureResponse;  }> {
     ...
     */
    public async listSecrets (secretSvcListSecretsRequest?: SecretSvcListSecretsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SecretSvcListSecretsResponse;  }> {
     ...
     */
    public async removeSecrets (secretSvcRemoveSecretsRequest: SecretSvcRemoveSecretsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: object;  }> {
        const localVarPath = this.basePath + '/secret-svc/secrets';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
     ...
     */
    public async saveSecrets (secretSvcSaveSecretsRequest: SecretSvcSaveSecretsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: object;  }> {
        const localVarPath = this.basePath + '/secret-svc/secrets';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
