...
export class FileSvcApi {
     ...
     */
    public async downloadFile (fileSvcDownloadFileRequest: FileSvcDownloadFileRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: { [key: string]: any; };  }> {
     ...
     * @param body 
     */
    public async getDownload (url: string, body?: object, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FileSvcGetDownloadResponse;  }> {
     ...
     * @param body 
     */
    public async listDownloads (body?: object, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FileSvcDownloadsResponse;  }> {
     ...
     */
    public async listUploads (fileSvcListUploadsRequest?: FileSvcListUploadsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FileSvcListUploadsResponse;  }> {
     ...
     * @param body 
     */
    public async pauseDownload (url: string, body?: object, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: { [key: string]: any; };  }> {
     ...
     */
    public async serveDownload (url: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RequestFile;  }> {
     ...
     * @param body 
     */
    public async serveUpload (fileId: string, body?: object, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RequestFile;  }> {
     ...
     */
    public async uploadFile (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FileSvcUploadFileResponse;  }> {
