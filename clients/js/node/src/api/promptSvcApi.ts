...
export class PromptSvcApi {
     ...
     */
    public async listPrompts (promptSvcListPromptsRequest?: PromptSvcListPromptsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PromptSvcListPromptsResponse;  }> {
     ...
     */
    public async prompt (promptSvcPromptRequest: PromptSvcPromptRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PromptSvcPromptResponse;  }> {
     ...
     */
    public async removePrompt (promptSvcRemovePromptRequest: PromptSvcRemovePromptRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: object;  }> {
