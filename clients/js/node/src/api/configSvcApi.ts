...
export class ConfigSvcApi {
    ...
    public async listConfigVersions (body: ConfigSvcListVersionsRequest, cacheControl?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ConfigSvcListVersionsResponse;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ConfigSvcListVersionsResponse;  }>((resolve, reject) => {
     ...
     * @param cacheControl Bypass cache (use \&#39;no-cache\&#39;)
     */
    public async listConfigs (body: ConfigSvcListConfigsRequest, cacheControl?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ConfigSvcListConfigsResponse;  }> {
