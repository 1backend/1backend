...
export class ConfigSvcApi {
     ...
     */
    public async listConfigs (configSvcListConfigsRequest?: ConfigSvcListConfigsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ConfigSvcListConfigsResponse;  }> {
     ...
     */
    public async saveConfig (configSvcSaveConfigRequest: ConfigSvcSaveConfigRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: object;  }> {
