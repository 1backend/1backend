...
export class ContainerSvcApi {
     ...
     */
    public async buildImage (containerSvcBuildImageRequest: ContainerSvcBuildImageRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: object;  }> {
     ...
     * @param body 
     */
    public async containerDaemonInfo (body?: object, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ContainerSvcDaemonInfoResponse;  }> {
     ...
     * @param body 
     */
    public async containerIsRunning (hash?: string, name?: string, body?: object, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ContainerSvcContainerIsRunningResponse;  }> {
     ...
     * @param body 
     */
    public async containerSummary (hash?: string, name?: string, lines?: number, body?: object, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ContainerSvcGetContainerSummaryResponse;  }> {
     ...
     * @param body 
     */
    public async getHost (body?: object, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ContainerSvcGetHostResponse;  }> {
     ...
     * @param body 
     */
    public async imagePullable (imageName: string, body?: object, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ContainerSvcImagePullableResponse;  }> {
     ...
     */
    public async listContainerLogs (containerSvcListLogsRequest: ContainerSvcListLogsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ContainerSvcListLogsResponse;  }> {
     ...
     */
    public async listContainers (containerSvcListContainersRequest: ContainerSvcListContainersRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ContainerSvcListContainersResponse;  }> {
     ...
     */
    public async runContainer (containerSvcRunContainerRequest: ContainerSvcRunContainerRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ContainerSvcRunContainerResponse;  }> {
     ...
     */
    public async stopContainer (containerSvcStopContainerRequest: ContainerSvcStopContainerRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: object;  }> {
