...
export class PolicySvcApi {
     ...
     */
    public async check (policySvcCheckRequest: PolicySvcCheckRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PolicySvcCheckResponse;  }> {
     ...
     */
    public async upsertInstance (instanceId: string, policySvcUpsertInstanceRequest: PolicySvcUpsertInstanceRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: object;  }> {
