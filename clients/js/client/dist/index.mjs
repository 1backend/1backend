 ...
 */
function instanceOfUserSvcCreateOrganizationResponse(value) {
...
function UserSvcCreateOrganizationResponseFromJSON(json) {
    return UserSvcCreateOrganizationResponseFromJSONTyped(json);
}
function UserSvcCreateOrganizationResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function UserSvcCreateOrganizationResponseToJSON(json) {
    return UserSvcCreateOrganizationResponseToJSONTyped(json, false);
}
function UserSvcCreateOrganizationResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
class UserSvcApi extends BaseAPI {
    ...
    createOrganizationRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new JSONApiResponse(response, (jsonValue) => UserSvcCreateOrganizationResponseFromJSON(jsonValue));
        });
    }
    /**
     * Allows a logged-in user to create a new organization. The user initiating the request will be assigned the role of admin for that organization. The initiating user will receive a dynamic role in the format `user-svc:org:{organizationId}:admin`, where `{organizationId}` is a unique identifier for the created organization. Dynamic roles are generated based on specific user-resource associations (in this case the resource being the organization), offering more flexible permission management compared to static roles.
