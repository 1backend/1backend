 ...
 */
function instanceOfUserSvcHasPermissionRequest(value) {
    return true;
}
function UserSvcHasPermissionRequestFromJSON(json) {
    return UserSvcHasPermissionRequestFromJSONTyped(json);
}
function UserSvcHasPermissionRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function UserSvcHasPermissionRequestToJSON(json) {
    return UserSvcHasPermissionRequestToJSONTyped(json, false);
}
function UserSvcHasPermissionRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
 ...
 * @export
 */
const UserSvcListUsersOrderByField = {
    ListUsersOrderByFieldCreatedAt: 'createdAt',
    ListUsersOrderByFieldUpdatedAt: 'updatedAt'
};
function instanceOfUserSvcListUsersOrderByField(value) {
...
function UserSvcListUsersOrderByFieldFromJSON(json) {
    return UserSvcListUsersOrderByFieldFromJSONTyped(json);
}
function UserSvcListUsersOrderByFieldFromJSONTyped(json, ignoreDiscriminator) {
    return json;
}
function UserSvcListUsersOrderByFieldToJSON(value) {
    return value;
}
function UserSvcListUsersOrderByFieldToJSONTyped(value, ignoreDiscriminator) {
    return value;
}
