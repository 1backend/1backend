 ...
 */
function instanceOfUserSvcListRolesResponse(value) {
    return true;
}
function UserSvcListRolesResponseFromJSON(json) {
    return UserSvcListRolesResponseFromJSONTyped(json);
}
function UserSvcListRolesResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function UserSvcListRolesResponseToJSON(json) {
    return UserSvcListRolesResponseToJSONTyped(json, false);
}
function UserSvcListRolesResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
class UserSvcApi extends BaseAPI {
    ...
    isAuthorizedRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters['permission'] == null) {
                throw new RequiredError('permission', 'Required parameter "permission" was null or undefined when calling isAuthorized().');
            }
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json';
            ...
            const response = yield this.request({
                path: `/user-svc/permission/{permission}/is-authorized`.replace(`{${"permission"}}`, encodeURIComponent(String(requestParameters['permission']))),
                method: 'POST',
                headers: headerParameters,
                query: queryParameters,
    ...
    listRolesRaw(initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new JSONApiResponse(response, (jsonValue) => UserSvcListRolesResponseFromJSON(jsonValue));
        });
    }
    /**
     * Retrieve all roles from the user service.
