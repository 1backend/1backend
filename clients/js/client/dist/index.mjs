...
function UserSvcInviteFromJSON(json) {
    return UserSvcInviteFromJSONTyped(json);
}
function UserSvcInviteFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function UserSvcInviteToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
 ...
 */
function instanceOfUserSvcInviteInput(value) {
    if (!('role' in value) || value['role'] === undefined)
        return false;
    return true;
}
function UserSvcInviteInputFromJSON(json) {
    return UserSvcInviteInputFromJSONTyped(json);
}
function UserSvcInviteInputFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function UserSvcInviteInputToJSON(json) {
    return UserSvcInviteInputToJSONTyped(json, false);
}
function UserSvcInviteInputToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
 ...
 */
function instanceOfUserSvcListInvitesRequest(value) {
    return true;
}
function UserSvcListInvitesRequestFromJSON(json) {
    return UserSvcListInvitesRequestFromJSONTyped(json);
}
function UserSvcListInvitesRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function UserSvcListInvitesRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
 ...
 */
function instanceOfUserSvcListInvitesResponse(value) {
    if (!('invites' in value) || value['invites'] === undefined)
        return false;
    return true;
}
function UserSvcListInvitesResponseFromJSON(json) {
    return UserSvcListInvitesResponseFromJSONTyped(json);
}
function UserSvcListInvitesResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function UserSvcListInvitesResponseToJSON(json) {
    return UserSvcListInvitesResponseToJSONTyped(json, false);
}
function UserSvcListInvitesResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
 ...
 */
function instanceOfUserSvcSaveInvitesRequest(value) {
    if (!('invites' in value) || value['invites'] === undefined)
        return false;
    return true;
}
function UserSvcSaveInvitesRequestFromJSON(json) {
    return UserSvcSaveInvitesRequestFromJSONTyped(json);
}
function UserSvcSaveInvitesRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function UserSvcSaveInvitesRequestToJSON(json) {
    return UserSvcSaveInvitesRequestToJSONTyped(json, false);
}
function UserSvcSaveInvitesRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
 ...
 */
function instanceOfUserSvcSaveInvitesResponse(value) {
    if (!('invites' in value) || value['invites'] === undefined)
        return false;
    return true;
}
function UserSvcSaveInvitesResponseFromJSON(json) {
    return UserSvcSaveInvitesResponseFromJSONTyped(json);
}
function UserSvcSaveInvitesResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function UserSvcSaveInvitesResponseToJSON(json) {
    return UserSvcSaveInvitesResponseToJSONTyped(json, false);
}
function UserSvcSaveInvitesResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
class UserSvcApi extends BaseAPI {
    ...
    listInvitesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters['body'] == null) {
                throw new RequiredError('body', 'Required parameter "body" was null or undefined when calling listInvites().');
            }
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json';
            ...
            return new JSONApiResponse(response, (jsonValue) => UserSvcListInvitesResponseFromJSON(jsonValue));
        });
    }
    /**
     * List user invites stored in the database.
    ...
    saveInvitesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters['body'] == null) {
                throw new RequiredError('body', 'Required parameter "body" was null or undefined when calling saveInvites().');
            }
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json';
            ...
            return new JSONApiResponse(response, (jsonValue) => UserSvcSaveInvitesResponseFromJSON(jsonValue));
        });
    }
    /**
     * Invite a list of users by contact or user Id to acquire a role. Works on future or current users.  A user can only invite an other user to a role if the user owns that role.  A user \"owns\" a role in the following cases: - A static role where the role ID is prefixed with the caller\'s slug. - Any dynamic or static role where the caller is an admin.  Examples: - A user with the slug \"joe-doe\" owns roles like \"joe-doe:any-custom-role\". - A user with any slug who has the role \"my-service:admin\" owns \"my-service:user\". - A user with any slug who has the role \"user-svc:org:{%orgId}:admin\" owns \"user-svc:org:{%orgId}:user\".
