...
function UserSvcNewInviteFromJSON(json) {
    return UserSvcNewInviteFromJSONTyped(json);
}
function UserSvcNewInviteFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function UserSvcNewInviteToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
