...
export declare const DatastoreOp: {
    ...
    readonly OpLessThan: "lessThan";
    readonly OpLessThanOrEqual: "lessThanOrEqual";
    readonly OpGreaterThan: "greaterThan";
    readonly OpGreaterThanOrEqual: "greaterThanOrEqual";
};
