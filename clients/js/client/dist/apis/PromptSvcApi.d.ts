...
export declare class PromptSvcApi extends runtime.BaseAPI {
     ...
     */
    listPromptsRequestOpts(requestParameters: ListPromptsRequest): Promise<runtime.RequestOpts>;
    /**
     ...
     */
    promptRequestOpts(requestParameters: PromptRequest): Promise<runtime.RequestOpts>;
    /**
     ...
     */
    promptTypesRequestOpts(requestParameters: PromptTypesRequest): Promise<runtime.RequestOpts>;
    /**
     ...
     */
    removePromptRequestOpts(requestParameters: RemovePromptRequest): Promise<runtime.RequestOpts>;
    /**
     ...
     */
    subscribeToPromptResponsesRequestOpts(requestParameters: SubscribeToPromptResponsesRequest): Promise<runtime.RequestOpts>;
    /**
