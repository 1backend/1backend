...
export declare class ConfigSvcApi extends runtime.BaseAPI {
     ...
     */
    listConfigVersionsRequestOpts(requestParameters: ListConfigVersionsRequest): Promise<runtime.RequestOpts>;
    /**
     ...
     * List Versions
     */
    listConfigVersionsRaw(requestParameters: ListConfigVersionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConfigSvcListVersionsResponse>>;
    /**
     * Returns the historical versions of a configuration for a given app. Intended for retrieving the version history of a **single configuration ID**. Supplying multiple IDs is supported but not recommended, since results from different IDs will interleave in the same time-ordered list, making chronological paging ambiguous.
     * List Versions
     */
    listConfigVersions(requestParameters: ListConfigVersionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConfigSvcListVersionsResponse>;
    /**
     * Creates request options for listConfigs without sending the request
     */
    listConfigsRequestOpts(requestParameters: ListConfigsRequest): Promise<runtime.RequestOpts>;
    /**
     ...
     */
    saveConfigRequestOpts(requestParameters: SaveConfigRequest): Promise<runtime.RequestOpts>;
    /**
