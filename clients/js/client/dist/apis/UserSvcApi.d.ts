...
export declare class UserSvcApi extends runtime.BaseAPI {
     ...
     */
    activateOrganizationRequestOpts(requestParameters: ActivateOrganizationRequest): Promise<runtime.RequestOpts>;
    /**
     ...
     */
    deleteMembershipRequestOpts(requestParameters: DeleteMembershipRequest): Promise<runtime.RequestOpts>;
    /**
     ...
     */
    exchangeTokenRequestOpts(requestParameters: ExchangeTokenRequest): Promise<runtime.RequestOpts>;
    /**
     ...
     */
    exchangeToken_1RequestOpts(requestParameters: ExchangeToken0Request): Promise<runtime.RequestOpts>;
    /**
     * Exchange an existing token for a new token scoped to a different app (namespace). The new token represents the same user but contains roles specific to the target app.  The original token remains valid. The minted token is not stored and cannot be refreshed (and will have the same expiration duration as normal tokens), unlike tokens acquired via login.  For now, token exchange is designed to be in situ — the User Svc must be contacted at exchange time. This introduces a stateful dependency on the User Svc, but simplifies things until broader use cases emerge.
     * Exchange Token
     */
     ...
     */
    getPublicKeyRequestOpts(): Promise<runtime.RequestOpts>;
    /**
     ...
     */
    hasPermissionRequestOpts(requestParameters: HasPermissionRequest): Promise<runtime.RequestOpts>;
    /**
     ...
     */
    listAppsRequestOpts(requestParameters: ListAppsRequest): Promise<runtime.RequestOpts>;
    /**
     ...
     */
    listEnrollsRequestOpts(requestParameters: ListEnrollsRequest): Promise<runtime.RequestOpts>;
    /**
     ...
     */
    listPermissionsRequestOpts(requestParameters: ListPermissionsRequest): Promise<runtime.RequestOpts>;
    /**
     ...
     */
    listPermitsRequestOpts(requestParameters: ListPermitsRequest): Promise<runtime.RequestOpts>;
    /**
     ...
     */
    readAppRequestOpts(requestParameters: ReadAppRequest): Promise<runtime.RequestOpts>;
    /**
     ...
     */
    readSelfRequestOpts(requestParameters: ReadSelfRequest): Promise<runtime.RequestOpts>;
    /**
     ...
     */
    refreshTokenRequestOpts(): Promise<runtime.RequestOpts>;
    /**
     ...
     */
    revokeTokensRequestOpts(requestParameters: RevokeTokensRequest): Promise<runtime.RequestOpts>;
    /**
     ...
     */
    saveEnrollsRequestOpts(requestParameters: SaveEnrollsRequest): Promise<runtime.RequestOpts>;
    /**
     ...
     */
    saveMembershipRequestOpts(requestParameters: SaveMembershipRequest): Promise<runtime.RequestOpts>;
    /**
     ...
     */
    saveOrganizationRequestOpts(requestParameters: SaveOrganizationRequest): Promise<runtime.RequestOpts>;
    /**
     ...
     */
    savePermitsRequestOpts(requestParameters: SavePermitsRequest): Promise<runtime.RequestOpts>;
    /**
     ...
     */
    saveSelfRequestOpts(requestParameters: SaveSelfRequest): Promise<runtime.RequestOpts>;
    /**
     ...
     */
    saveUserRequestOpts(requestParameters: SaveUserRequest): Promise<runtime.RequestOpts>;
    /**
     ...
     */
    sendOtpRequestOpts(requestParameters: SendOtpRequest): Promise<runtime.RequestOpts>;
    /**
     ...
     */
    updateAppRequestOpts(requestParameters: UpdateAppRequest): Promise<runtime.RequestOpts>;
    /**
