...
export declare class RegistrySvcApi extends runtime.BaseAPI {
     ...
     */
    echoPostRaw(requestParameters: EchoPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{
        [key: string]: any;
    }>>;
    /**
     * This endpoint is used to test the server\'s response to a request. It simply echoes back the request body as a JSON response.
     * Echo the request body in the response body.
     */
    echoPost(requestParameters?: EchoPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<{
        [key: string]: any;
    }>;
    /**
     * This endpoint is used to test the server\'s response to a request. It simply echoes back the request body as a JSON response.
     * Echo the request body in the response body.
     */
    echoPutRaw(requestParameters: EchoPutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{
        [key: string]: any;
    }>>;
    /**
     * This endpoint is used to test the server\'s response to a request. It simply echoes back the request body as a JSON response.
     * Echo the request body in the response body.
     */
    echoPut(requestParameters?: EchoPutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<{
        [key: string]: any;
    }>;
    /**
     ...
     * List Definitions
     */
    listDefinitionsRaw(requestParameters: ListDefinitionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrySvcListDefinitionsResponse>>;
    /**
     * Retrieves a list of all definitions or filters them by specific criteria.
     * List Definitions
     */
    listDefinitions(requestParameters?: ListDefinitionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrySvcListDefinitionsResponse>;
    /**
