...
export declare class SecretSvcApi extends runtime.BaseAPI {
     ...
     */
    isSecureRaw(requestParameters: IsSecureRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SecretSvcIsSecureResponse>>;
    /**
     * Returns true if the encryption key is sufficiently secure.
     * Check Security Status
     */
    isSecure(requestParameters?: IsSecureRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SecretSvcIsSecureResponse>;
    /**
