...
export declare class FirehoseSvcApi extends runtime.BaseAPI {
     ...
     */
    subscribeToEventsRaw(requestParameters: SubscribeToEventsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>>;
    /**
     * Establish a subscription to the firehose events and accept a real time stream of them.
     * Subscribe to the Event Stream
     */
    subscribeToEvents(requestParameters?: SubscribeToEventsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string>;
}
