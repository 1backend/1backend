...
import {
    ...
    ConfigSvcListVersionsRequestFromJSON,
    ConfigSvcListVersionsRequestToJSON,
    ConfigSvcListVersionsResponseFromJSON,
...
export class ConfigSvcApi extends runtime.BaseAPI {
    ...
    async listConfigVersionsRaw(requestParameters: ListConfigVersionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConfigSvcListVersionsResponse>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling listConfigVersions().'
            );
        }
     ...
     * List Versions
     */
    async listConfigVersions(requestParameters: ListConfigVersionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConfigSvcListVersionsResponse> {
        const response = await this.listConfigVersionsRaw(requestParameters, initOverrides);
