...
export class ModelSvcApi extends runtime.BaseAPI {
     ...
     */
    async getDefaultModelStatusRaw(requestParameters: GetDefaultModelStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelSvcStatusResponse>> {
     ...
     * Get Default Model Status
     */
    async getDefaultModelStatus(requestParameters: GetDefaultModelStatusRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelSvcStatusResponse> {
        const response = await this.getDefaultModelStatusRaw(requestParameters, initOverrides);
     ...
     * List Models
     */
    async listModelsRaw(requestParameters: ListModelsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelSvcListModelsResponse>> {
        const queryParameters: any = {};
     ...
     * List Models
     */
    async listModels(requestParameters: ListModelsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelSvcListModelsResponse> {
     ...
     * List Platforms
     */
    async listPlatformsRaw(requestParameters: ListPlatformsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelSvcListPlatformsResponse>> {
        const queryParameters: any = {};
     ...
     * List Platforms
     */
    async listPlatforms(requestParameters: ListPlatformsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelSvcListPlatformsResponse> {
        const response = await this.listPlatformsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async startDefaultModelRaw(requestParameters: StartDefaultModelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>> {
        const queryParameters: any = {};
     ...
     * Start the Default Model
     */
    async startDefaultModel(requestParameters: StartDefaultModelRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
        const response = await this.startDefaultModelRaw(requestParameters, initOverrides);
        return await response.value();
    }
