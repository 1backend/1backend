...
export interface EchoPutRequest {
    body?: object;
}
...
export class RegistrySvcApi extends runtime.BaseAPI {
     ...
     */
    async echoPostRaw(requestParameters: EchoPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: any; }>> {
        const queryParameters: any = {};
     ...
     * Echo the request body in the response body.
     */
    async echoPost(requestParameters: EchoPostRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<{ [key: string]: any; }> {
     ...
     * Echo the request body in the response body.
     */
    async echoPutRaw(requestParameters: EchoPutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: any; }>> {
        const queryParameters: any = {};
     ...
     * Echo the request body in the response body.
     */
    async echoPut(requestParameters: EchoPutRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<{ [key: string]: any; }> {
        const response = await this.echoPutRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * List Definitions
     */
    async listDefinitionsRaw(requestParameters: ListDefinitionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrySvcListDefinitionsResponse>> {
        const queryParameters: any = {};
     ...
     * List Definitions
     */
    async listDefinitions(requestParameters: ListDefinitionsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrySvcListDefinitionsResponse> {
