...
type RegistrySvcAPI interface {
	...
	*/
	...
	/*
	EchoGet Echo the query parameters in the response body.
...
It echoes back the query parameters as a JSON object.
	...
	*/
	EchoGet(ctx context.Context) ApiEchoGetRequest

	// EchoGetExecute executes the request
	//  @return map[string]interface{}
	EchoGetExecute(r ApiEchoGetRequest) (map[string]interface{}, *http.Response, error)

	/*
	EchoPost Echo the request body in the response body.
...
It simply echoes back the request body as a JSON response.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiEchoPostRequest
	*/
	EchoPost(ctx context.Context) ApiEchoPostRequest

	// EchoPostExecute executes the request
	//  @return map[string]interface{}
	EchoPostExecute(r ApiEchoPostRequest) (map[string]interface{}, *http.Response, error)

	/*
	EchoPut Echo the request body in the response body.

	This endpoint is used to test the server's response to a request.
It simply echoes back the request body as a JSON response.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiEchoPutRequest
	*/
	EchoPut(ctx context.Context) ApiEchoPutRequest

	// EchoPutExecute executes the request
	//  @return map[string]interface{}
	EchoPutExecute(r ApiEchoPutRequest) (map[string]interface{}, *http.Response, error)
...
func (r ApiEchoGetRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
It echoes back the query parameters as a JSON object.
 ...
 @return ApiEchoGetRequest
*/
func (a *RegistrySvcAPIService) EchoGet(ctx context.Context) ApiEchoGetRequest {
	return ApiEchoGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return map[string]interface{}
func (a *RegistrySvcAPIService) EchoGetExecute(r ApiEchoGetRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RegistrySvcAPIService.EchoGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/registry-svc/echo"
...
func (r ApiEchoPostRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.EchoPostExecute(r)
}
...
It simply echoes back the request body as a JSON response.
 ...
 @return ApiEchoPostRequest
*/
func (a *RegistrySvcAPIService) EchoPost(ctx context.Context) ApiEchoPostRequest {
	return ApiEchoPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return map[string]interface{}
func (a *RegistrySvcAPIService) EchoPostExecute(r ApiEchoPostRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RegistrySvcAPIService.EchoPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiEchoPutRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.EchoPutExecute(r)
}
...
It simply echoes back the request body as a JSON response.
 ...
 @return ApiEchoPutRequest
*/
func (a *RegistrySvcAPIService) EchoPut(ctx context.Context) ApiEchoPutRequest {
	return ApiEchoPutRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return map[string]interface{}
func (a *RegistrySvcAPIService) EchoPutExecute(r ApiEchoPutRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RegistrySvcAPIService.EchoPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
