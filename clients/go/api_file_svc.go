...
type FileSvcAPI interface {
	...
	/*
	DeleteUpload Delete an Uploaded File
...
Requires the `file-svc:upload:delete` permission.
	...
	*/
	DeleteUpload(ctx context.Context, fileId string) ApiDeleteUploadRequest

	// DeleteUploadExecute executes the request
	//  @return map[string]interface{}
	DeleteUploadExecute(r ApiDeleteUploadRequest) (map[string]interface{}, *http.Response, error)
...
func (r ApiDeleteUploadRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
Requires the `file-svc:upload:delete` permission.
 ...
 @return ApiDeleteUploadRequest
*/
func (a *FileSvcAPIService) DeleteUpload(ctx context.Context, fileId string) ApiDeleteUploadRequest {
	return ApiDeleteUploadRequest{
		ApiService: a,
		ctx: ctx,
		fileId: fileId,
...
//  @return map[string]interface{}
func (a *FileSvcAPIService) DeleteUploadExecute(r ApiDeleteUploadRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FileSvcAPIService.DeleteUpload")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/file-svc/upload/{fileId}"
