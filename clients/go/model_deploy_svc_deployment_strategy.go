...
// DeploySvcDeploymentStrategy Deployment strategy (e.g., rolling update)
...
func (o *DeploySvcDeploymentStrategy) GetType() string {
...
// and a boolean to check if the value has been set.
func (o *DeploySvcDeploymentStrategy) GetTypeOk() (*string, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *DeploySvcDeploymentStrategy) SetType(v string) {
	o.Type = &v
}
