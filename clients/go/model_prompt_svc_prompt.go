...
// PromptSvcPrompt Prompt contains the details of the prompt that was just created by this request. This includes the ID, prompt text, status, and other associated metadata.
...
func (o *PromptSvcPrompt) GetStatus() string {
...
// and a boolean to check if the value has been set.
func (o *PromptSvcPrompt) GetStatusOk() (*string, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *PromptSvcPrompt) SetStatus(v string) {
	o.Status = &v
}
...
func (o *PromptSvcPrompt) GetType() string {
...
// and a boolean to check if the value has been set.
func (o *PromptSvcPrompt) GetTypeOk() (*string, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *PromptSvcPrompt) SetType(v string) {
	o.Type = &v
}
