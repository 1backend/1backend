...
Caller can only delete enrolls of roles they own (unless they are an admin).
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiDeleteEnrollsRequest
	*/
	DeleteEnrolls(ctx context.Context) ApiDeleteEnrollsRequest

	// DeleteEnrollsExecute executes the request
	//  @return map[string]interface{}
	DeleteEnrollsExecute(r ApiDeleteEnrollsRequest) (map[string]interface{}, *http.Response, error)
...
type ApiDeleteEnrollsRequest struct {
	ctx context.Context
	ApiService UserSvcAPI
	body *UserSvcDeleteEnrollsRequest
}

// Delete Enrolls Request
func (r ApiDeleteEnrollsRequest) Body(body UserSvcDeleteEnrollsRequest) ApiDeleteEnrollsRequest {
	r.body = &body
	return r
}

func (r ApiDeleteEnrollsRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.DeleteEnrollsExecute(r)
}
...
Caller can only delete enrolls of roles they own (unless they are an admin).
 ...
 @return ApiDeleteEnrollsRequest
*/
func (a *UserSvcAPIService) DeleteEnrolls(ctx context.Context) ApiDeleteEnrollsRequest {
	return ApiDeleteEnrollsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return map[string]interface{}
func (a *UserSvcAPIService) DeleteEnrollsExecute(r ApiDeleteEnrollsRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserSvcAPIService.DeleteEnrolls")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
