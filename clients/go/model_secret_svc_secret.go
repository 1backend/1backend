...
func (o *SecretSvcSecret) GetChecksumAlgorithm() string {
...
// and a boolean to check if the value has been set.
func (o *SecretSvcSecret) GetChecksumAlgorithmOk() (*string, bool) {
	if o == nil || IsNil(o.ChecksumAlgorithm) {
		return nil, false
	}
...
func (o *SecretSvcSecret) SetChecksumAlgorithm(v string) {
