...
*FileSvcAPI* | [**DeleteUpload**](docs/FileSvcAPI.md#deleteupload) | **Delete** /file-svc/upload/{fileId} | Delete an Uploaded File
...
*ImageSvcAPI* | [**ServeDownloadedImage**](docs/ImageSvcAPI.md#servedownloadedimage) | **Get** /image-svc/serve/download/{url} | Serve Downloaded Image
...
*UserSvcAPI* | [**BeginTOTPSetup**](docs/UserSvcAPI.md#begintotpsetup) | **Post** /user-svc/totp/setup | Begin TOTP Setup
...
*UserSvcAPI* | [**EnableTOTP**](docs/UserSvcAPI.md#enabletotp) | **Post** /user-svc/totp/enable | Enable TOTP
...
*UserSvcAPI* | [**ListOIDCContactAuthProviders**](docs/UserSvcAPI.md#listoidccontactauthproviders) | **Get** /user-svc/oidc/providers | List OIDC Contact Auth Providers
...
*UserSvcAPI* | [**ReadTOTPStatus**](docs/UserSvcAPI.md#readtotpstatus) | **Post** /user-svc/totp/status | Read TOTP Status
...
*UserSvcAPI* | [**ServeTOTPQRCode**](docs/UserSvcAPI.md#servetotpqrcode) | **Get** /user-svc/totp/setup/{totpId}/qr.png | Serve TOTP QR Code
...
## Documentation For Models
 ...
 - [ConfigSvcConfigPatchOperation](docs/ConfigSvcConfigPatchOperation.md)
 ...
 - [UserSvcBeginTOTPSetupRequest](docs/UserSvcBeginTOTPSetupRequest.md)
 - [UserSvcBeginTOTPSetupResponse](docs/UserSvcBeginTOTPSetupResponse.md)
 - [UserSvcChangePasswordRequest](docs/UserSvcChangePasswordRequest.md)
 - [UserSvcContact](docs/UserSvcContact.md)
 - [UserSvcContactAuthLoginRequest](docs/UserSvcContactAuthLoginRequest.md)
 ...
 - [UserSvcReadTOTPStatusRequest](docs/UserSvcReadTOTPStatusRequest.md)
 - [UserSvcReadTOTPStatusResponse](docs/UserSvcReadTOTPStatusResponse.md)
