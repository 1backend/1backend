                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/proxy_svc.SaveCertsRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/proxy_svc.SaveCertsResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid JSON",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/user_svc.RefreshTokenResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
    ...
    "definitions": {
        ...
        "proxy_svc.Cert": {
            ...
            "properties": {
                ...
                "id": {
                    "description": "Id is the host which this cert is for, e.g., \"example.com\" or \"www.example.com\"",
                    "type": "string",
                    "example": "example.com"
                },
                "isCA": {
        ...
        "proxy_svc.ListCertsResponse": {
            ...
            "properties": {
                "certs": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/proxy_svc.Cert"
                    }
                }
            }
        },
        ...
        "proxy_svc.SaveCertsRequest": {
            ...
            "properties": {
                "certs": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/proxy_svc.CertInput"
                    }
                }
            }
        },
