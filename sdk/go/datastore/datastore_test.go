...
func TestAll(t *testing.T) {
	...
	tests := map[string]func(t *testing.T, store datastore.DataStore){
		...
		"UpsertPartial":          datastore.TestUpsertPartial,
		"UpsertManyPartial":      datastore.TestUpsertManyPartial,
		"PatchMany":              datastore.TestPatchMany,
		...
		"PaginationMultipleKeys": datastore.TestPaginationMultipleKeys,
		"FindOne":                datastore.TestFindOne,
		"Update":                 datastore.TestUpdate,
		"Map":                    datastore.TestMap,
		"Contains":               datastore.TestContains,
		"ComparisonOperators":    datastore.TestComparisonOperators,
		"DotNotationComparison":  datastore.TestDotNotationComparisonOperators,
	...
	pointerTests := map[string]func(t *testing.T, store datastore.DataStore){
		...
		"PointerUpsertPartial":          datastore.TestPointerUpsertPartial,
		"PointerUpsertManyPartial":      datastore.TestPointerUpsertManyPartial,
		"PointerPatchMany":              datastore.TestPointerPatchMany,
		...
		"PointerPaginationMultipleKeys": datastore.TestPointerPaginationMultipleKeys,
		"PointerFindOne":                datastore.TestPointerFindOne,
		"PointerUpdate":                 datastore.TestPointerUpdate,
		"MapPointer":                    datastore.TestMapPointer,
		"PointerComparisonOperators":    datastore.TestPointerComparisonOperators,
		"PointerDotNotationComparison":  datastore.TestPointerDotNotationComparisonOperators,
